...
try{
    $ppk = FlagPpkDukman::find()->select("nip")->where(['id_instansi'=>Yii::$app->user->identity->id_instansi])->one()->nip0->nama;
}catch(Exception $e){
...
<div class="flag-ppk-create">
    <div class="alert alert-warning alert-dismissable">
        ...
        <strong>Warning!</strong> Form dibawah ini berguna untuk mengubah PPK Dukman.
