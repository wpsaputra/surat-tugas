 ...
 */
class PpkDukmanController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        if (($model = FlagPpkDukman::findOne($id)) !== null) {
            return $model;
        }
